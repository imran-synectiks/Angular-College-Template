...
import { ClassaddComponent } from './class/classadd/classadd.component';
import { ClasslistComponent } from './class/classlist/classlist.component';
...
export const ComponentsRoutes: Routes = [
   {
    ...
    children: [
    ...
    },
     {
      ...
      data:  {
        title: 'Add New',
        urls: [ {title: 'Class', url: '/dashboard'}, {title: 'Add New'}]
      }
    },
       {
        path: 'study/classlist',
        component: ClasslistComponent,
        data:  {
          title: 'Class List',
          urls: [ {title: 'Class', url: '/dashboard'}, {title: 'Class List'}]
        }
      },]
  }
];
